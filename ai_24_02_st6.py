...
Original file is located at
    https://colab.research.google.com/drive/1zoSpkADzJLsIQiCSIofUK8dcbMUC3Z1n
"""
...
medium_fasl = fuzz.trimf(x,[30,60,80])
plt.figure()
plt.plot(x,slow,'v',linewidth =1.5,label='slow')
plt.plot(x,medium,'v',linewidth =1.5,label='medium')
plt.plot(x,medium_fasl,'v',linewidth =1.5,label='medium_fasl')

x = np.arange (30,81,1)
slow = fuzz.goussmf(x,30,4)
medium = fuzz.goussmf(x,40,4)
medium_fasl = fuzz.goussmf(x,50,4)
plt.figure()
plt.plot(x,slow,'v',linewidth =1.5,label='slow')
plt.plot(x,medium,'v',linewidth =1.5,label='medium')
plt.plot(x,medium_fasl,'v',linewidth =1.5,label='medium_fasl')
